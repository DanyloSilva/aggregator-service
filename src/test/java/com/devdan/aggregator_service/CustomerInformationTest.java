...
mockCustomerInformation("custumer-information-200.json",200);
getCustomerInformation(HttpStatus.OK)
    ...
    public void customerNotFound() {
        mockCustomerInformation("custumer-information-404.json", 404);
...
private void mockCustomerInformation(String path, int responseCode){
    var responseBody = this.customerServiceResource(path);
