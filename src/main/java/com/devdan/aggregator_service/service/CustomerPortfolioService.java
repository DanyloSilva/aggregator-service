package com.devdan.aggregator_service.service;
...
import com.devdan.aggregator_service.dto.*;
...
return this.customerServiceClient.getCustomerInformation(customerId);
    ...
    public Mono<StockTraadeResponse> trade (Integer customerId, TradeRequest request){
