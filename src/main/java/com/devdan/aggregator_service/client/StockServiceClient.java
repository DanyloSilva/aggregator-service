...
import com.devdan.aggregator_service.dto.StockPriceResponse;
...
public class StockServiceClient {
  ...
  private Flux<PriceUpdate> getPriceUpdates(){
      return this.client.get()
              ...
              .accept(MediaType.APPLICATION_NDJSON).retrieve().bodyToFlux(PriceUpdate.class)
              .retryWhen(retry()).cache(1);
  }
  ...
  private Retry retry (){
      return Retry
              ...
              .doBeforeRetry(rs -> log.error("stock service stream call failed.",
